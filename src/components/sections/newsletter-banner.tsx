...
const NewsletterBanner: React.FC<NewsletterBannerType> = ({
  ...
  return (
    ...
    >
      <div className="flex-1 rounded-lg overflow-hidden flex flex-row items-center justify-center py-[6.125rem] px-[0.5rem] box-border bg-[url('/images/newsletter-bg.png')] bg-cover bg-no-repeat bg-[center] max-w-full">
